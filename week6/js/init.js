...
function addMarker(data){
    ...
    L.marker([data.lat,data.lng]).addTo(map).bindPopup(`<h2>${data['What type of dessert does your favorite dessert spot serve?']}</h2> <h3>${data['Where is your favorite dessert spot located?']}`)
